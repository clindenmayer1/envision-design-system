...
export class EnvisionMaterialSwatch extends EnvisionElement {
    ...
    get unavailable() { return this.getBool('unavailable'); }
    set unavailable(v) { this.reflectBool('unavailable', v); }
    #field(key, attr) {
        return this.#option?.[key] ?? this.getStr(attr) ?? '';
    }
    connectedCallback() {
...
//# sourceMappingURL=MaterialSwatch.js.map