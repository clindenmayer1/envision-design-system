...
export class EnvisionRadio extends EnvisionElement {
    ...
    set name(v) { this.setStr('name', v); }
    get value() { return this.getStr('value') ?? ''; }
    ...
    #group() {
        ...
        const all = Array.from(rootNode.querySelectorAll(`envision-radio[name="${cssEscape(this.name)}"]`));
