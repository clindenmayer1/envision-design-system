...
const sources = new WeakMap<CSSStyleSheet, string>();

export function css(
  strings: TemplateStringsArray,
  ...values: Array<string | number | CSSStyleSheet>
): CSSStyleSheet {
...
export function cssSource(sheet: CSSStyleSheet | CSSStyleSheet[] | undefined): string {
