...
export class EnvisionLink extends EnvisionElement {
  ...
  get href(): string { return this.getStr('href') ?? ''; }
  set href(v: string) { this.setStr('href', v); }
  get label(): string { return this.getStr('label') ?? ''; }
  set label(v: string) { this.setStr('label', v); }
  get variant(): Variant { return this.getEnum('variant', VARIANTS, 'inline'); }
  set variant(v: Variant) { this.setStr('variant', v); }
  get directionIcon(): boolean { return this.getBool('direction-icon'); }
  set directionIcon(v: boolean) { this.reflectBool('direction-icon', v); }
  get disabled(): boolean { return this.getBool('disabled'); }
  set disabled(v: boolean) { this.reflectBool('disabled', v); }

  connectedCallback(): void {
    if (!this.hasAttribute('variant')) this.setAttribute('variant', 'inline');
