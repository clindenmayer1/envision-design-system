 ...
 *
 *   node scripts/tokenize.mjs <file...>            # apply
 *   node scripts/tokenize.mjs --dry <file...>      # report only
 */
...
for (const file of files) {
  ...
  console.log(`${file.replace('src/components/', '').padEnd(42)} ${String(changed).padStart(4)} declarations tokenized`);
}
